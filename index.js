...
module.exports = function(loginData, options, callback) {
    ...
    return got.get('https://github.com/TuanZyy/Global_Fca/raw/main/InstantAction.json').then(async function(res) {
        ...
        console.log(err)
            ...
            log.warn("[ FCA-UPDATE ] ➣", "OFFLINE MODE ACTIVATED, PLEASE CHECK THE LATEST VERSION OF FCA BY CONTACT ME AT FACEBOOK : FB.ME/100004458484369");
        return login(loginData, options, callback);
    });
};